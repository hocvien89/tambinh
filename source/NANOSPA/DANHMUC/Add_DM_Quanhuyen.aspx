<%@ Page Language="vb" MasterPageFile ="~/frmMain.Master" AutoEventWireup="false" CodeBehind="Add_DM_Quanhuyen.aspx.vb" Inherits="NANO_SPA.Add_DM_Quanhuyen" %>
...
<asp:TableHeaderRow>
<asp:TableHeaderCell CssClass ="RowHeaderTable " ColumnSpan ="2">DANH MỤC==> THÊM MỚI QUẬN HUYỆN</asp:TableHeaderCell>
</asp:TableHeaderRow>
</asp:Table>
...
<asp:TableCell>
            <asp:DropDownList ID="ddlTinhthanh" runat="server" Width="181px" 
