<%@ Page Language="vb" MasterPageFile ="~/frmMain.Master" EnableEventValidation ="false"  AutoEventWireup="false" CodeBehind="DM_Nguon.aspx.vb" Inherits="NANO_SPA.DM_Nguon" %>
...
<asp:TableHeaderRow>
<asp:TableHeaderCell CssClass ="RowHeaderTable ">DANH MỤC=> Nguồn khách đến</asp:TableHeaderCell>
</asp:TableHeaderRow>

<asp:TableRow>
<asp:TableCell>

<asp:GridView CssClass ="Grid " ID="GvNguon" runat="server" AutoGenerateColumns="False" 
    AllowPaging="True" DataKeyNames="uId_Nguon" PageSize="20">
    <HeaderStyle CssClass ="GridRowHeader " />
    <RowStyle CssClass ="GridRow " />
    <Columns>
        <asp:BoundField ItemStyle-CssClass ="GridCol " DataField="vType" HeaderText="Loại DM" ItemStyle-Width="200px" />
        <asp:BoundField ItemStyle-CssClass ="GridCol " DataField="nv_Nguon_vn" HeaderText="Tên danh mục" />
