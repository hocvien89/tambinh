<%@ Page Language="vb" MasterPageFile ="~/frmMain.Master" EnableEventValidation ="false"  AutoEventWireup="false" CodeBehind="DM_Nhacungcap.aspx.vb" Inherits="NANO_SPA.DM_Nhacungcap" %>
...
<asp:TableHeaderRow>
<asp:TableHeaderCell CssClass ="RowHeaderTable ">DANH MỤC=> Nhà cung cấp</asp:TableHeaderCell>
</asp:TableHeaderRow>

<asp:TableRow>
<asp:TableCell>

<asp:GridView ID="GvNhacungcap" runat="server" AutoGenerateColumns="False" 
    AllowPaging="True" DataKeyNames="uId_Nhacungcap" CssClass ="Grid ">
    <HeaderStyle CssClass ="GridRowHeader " />
    <RowStyle CssClass ="GridRow " />
    <Columns>
        <asp:BoundField ItemStyle-CssClass ="GridCol " DataField="v_Manhacungcap" 
            HeaderText="Mã NCC"  ItemStyle-Width="80px"/>
        <asp:BoundField ItemStyle-CssClass ="GridCol " DataField="nv_Tennhacungcap_vn" HeaderText="Tên Nhà Cung Cấp"  ItemStyle-Width="300px"/>
        <asp:BoundField ItemStyle-CssClass ="GridCol " DataField="nv_Diachi_vn" HeaderText="Địa chỉ" />
