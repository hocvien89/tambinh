<%@ Page Language="vb" MasterPageFile ="~/frmMain.Master" AutoEventWireup="false" CodeBehind="Add_DM_Quocgia.aspx.vb" Inherits="NANO_SPA.Add_DM_Quocgia" %>
...
<asp:TableHeaderRow>
<asp:TableHeaderCell CssClass ="RowHeaderTable " ColumnSpan ="2">DANH MỤC==> THÊM MỚI QUỐC GIA</asp:TableHeaderCell>
</asp:TableHeaderRow>
</asp:Table>
...
<asp:Table ID="tblAdd_DM_Quocgia" Width="100%" runat ="server" >
<asp:TableRow>
