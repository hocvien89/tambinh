<%@ Page Language="vb" MasterPageFile="~/frmMain.Master" EnableEventValidation ="false"  AutoEventWireup="false" CodeBehind="DM_Loaimathang.aspx.vb" Inherits="NANO_SPA.DM_Loaimathang" %>
...
<asp:TableHeaderRow>
<asp:TableHeaderCell CssClass ="RowHeaderTable ">DANH MỤC=> Loại mặt hàng</asp:TableHeaderCell>
</asp:TableHeaderRow>

<asp:TableRow>
<asp:TableCell>

<asp:GridView  CssClass ="Grid " ID="GvLoaimathang" runat="server" AutoGenerateColumns="False" 
    AllowPaging="True" DataKeyNames="uId_Loaimathang">
    <HeaderStyle CssClass  ="GridRowHeader " />
    <RowStyle CssClass ="GridRow " />
    <Columns>
        <asp:BoundField ItemStyle-CssClass ="GridCol " DataField="nv_Tenloaimathang_vn" 
            HeaderText="Tên Loại Mặt Hàng" />
