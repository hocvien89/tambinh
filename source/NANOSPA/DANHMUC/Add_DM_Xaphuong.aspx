<%@ Page Language="vb" MasterPageFile ="~/frmMain.Master" AutoEventWireup="false" CodeBehind="Add_DM_Xaphuong.aspx.vb" Inherits="NANO_SPA.Add_DM_Xaphuong" %>
...
<asp:TableHeaderRow>
<asp:TableHeaderCell CssClass ="RowHeaderTable " ColumnSpan ="2">DANH MỤC==> THÊM MỚI XÃ PHƯỜNG</asp:TableHeaderCell>
</asp:TableHeaderRow>
</asp:Table>
...
<asp:TableCell>
            <asp:DropDownList ID="ddlQuanhuyen" runat="server" Width="181px" 
