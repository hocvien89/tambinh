<%@ Page Language="vb" MasterPageFile ="~/frmMain.Master" EnableEventValidation ="false"  AutoEventWireup="false" CodeBehind="DM_Nhommathang.aspx.vb" Inherits="NANO_SPA.DM_Nhommathang" %>
...
<asp:TableHeaderRow>
<asp:TableHeaderCell CssClass ="RowHeaderTable ">DANH MỤC=> Nhóm mặt hàng</asp:TableHeaderCell>
</asp:TableHeaderRow>

<asp:TableRow>
<asp:TableCell>

<asp:GridView ID="GvNhommathang" runat="server" CssClass ="Grid " AutoGenerateColumns="False" 
    AllowPaging="True" DataKeyNames="uId_Nhommathang" AllowSorting ="true"  PageSize="15"  >
    <HeaderStyle CssClass ="GridRowHeader " />
    <RowStyle CssClass ="GridRow " />
    <Columns>
        <asp:BoundField ItemStyle-CssClass ="GridCol " DataField="nv_Tennhommathang_vn" 
            HeaderText="Tên Nhóm Mặt Hàng" SortExpression ="nv_Tennhommathang_vn" />
