<%@ Page Language="vb" MasterPageFile ="~/frmMain.Master"  AutoEventWireup="false" CodeBehind="Add_DM_Nhomthamdo.aspx.vb" Inherits="NANO_SPA.Add_DM_Nhomthamdo" %>
...
<asp:TableHeaderRow>
<asp:TableHeaderCell CssClass ="RowHeaderTable "  ColumnSpan ="2">DANH MỤC==> THÊM MỚI NHÓM THĂM DÒ</asp:TableHeaderCell>
</asp:TableHeaderRow>
</asp:Table>
...
<asp:TableRow>
<asp:TableCell CssClass ="RowHeaderTable " Width="40%">
