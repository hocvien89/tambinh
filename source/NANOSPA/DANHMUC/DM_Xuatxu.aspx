<%@ Page Language="vb" MasterPageFile="~/frmMain.Master" EnableEventValidation ="false"  AutoEventWireup="false" CodeBehind="DM_Xuatxu.aspx.vb" Inherits="NANO_SPA.DM_Xuatxu" %>
...
<asp:TableHeaderRow>
<asp:TableHeaderCell CssClass ="RowHeaderTable ">DANH MỤC=> Xuất sứ</asp:TableHeaderCell>
</asp:TableHeaderRow>

<asp:TableRow>
<asp:TableCell>

<asp:GridView CssClass ="Grid " ID="GvXuatXu" runat="server" AutoGenerateColumns="False" 
    AllowPaging="True" DataKeyNames="uid_Xuatxu">
    <HeaderStyle CssClass ="GridRowHeader " />
    <RowStyle CssClass ="GridRow " />
    <Columns>
        <asp:BoundField ItemStyle-CssClass ="GridCol " DataField="nv_Tenxuatxu_vn" HeaderText="Tên Xuất Xứ" />
