    ...
    <form id="form1" runat="server">
            ...
            <div class="home_box_top">
                ...
                <div class="home_box home_box_4">
                    <div class="home_box_row">
                        ...
                        <div class="home_box_row_right">
                            <span class="box_text_header">SINH NHẬT BỆNH NHÂN</span><div class="clearboth_ipad"></div>
                            <span style="font-size: 18px; position: relative; top: 8px"><i class="fa fa-angle-double-right"></i>Trong ngày:
                            ...
                            <div class="clearboth_ipad"></div>
                            <span style="font-size: 18px; position: relative; top: 18px"><i class="fa fa-angle-double-right"></i>Trong tháng:
                            <asp:LinkButton OnClick="lbtnViewMont_Click" PostBackUrl="../../../OrangeVersion/Customer/CustomerBirthday.aspx" Style="font-size: 18px; position: relative; color: White" runat="server"
                                ID="lbtnViewMont" Text="0"></asp:LinkButton></span>
                            <div class="clearboth_ipad"></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-4" style="float: left; width: 22.333%; margin-top: 16px;">
            <div class="panel panel-primary">
                ...
                <div class="panel-body" style="width: 100%; height: 461px">
                    <ul class="chat">
                            ...
                            <ItemTemplate>
                                <li class="left clearfix">
                                    <span class="chat-img pull-left" style="width: 45px; height: 50px; border: dashed thin; text-align: center; border-color: orange">
                                        ...
                                        <img src="<%#Eval("nv_Quequan_en")%>" alt="No Avatar" style="width: 35px; height: 35px">
                                    </span>
                                    <div class="chat-body clearfix" style="padding-left: 10px">
                                        <div class="header">
                                            ...
                                            <small class="pull-right text-muted">
                                                <%#BO.Util.FormatNearTime(Eval("ngaygio"))%>
                                            </small>
                                        </div>
