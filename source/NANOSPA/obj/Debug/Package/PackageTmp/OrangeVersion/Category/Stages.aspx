<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Stages.aspx.vb" Inherits="NANO_SPA.Stages" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    ...
    <div class="brest_crum">
        <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>DANH MỤC ĐIỀU TRỊ CÔNG ĐOẠN</p>
    </div>
    <fieldset class="field_tt_left" style="width: 98%; height: auto; margin: auto">
        <dx:ASPxGridView ID="Grid_DMCongdoan" runat="server" KeyFieldName="uId_Congdoan" Width="100%"
            >
            <Columns>
                <dx:GridViewDataTextColumn Visible="false" VisibleIndex="-1" Settings-AutoFilterCondition="Contains"
                    HeaderStyle-HorizontalAlign="Center"
                    Caption="" FieldName="uId_Congdoan" Name="uId_Congdoan">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataColumn Caption="Mã công đoạn" VisibleIndex="1" FieldName="v_Macongdoan" Width="200px"
                    Name="v_Macongdoan" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains">
                </dx:GridViewDataColumn>
                <dx:GridViewDataColumn Visible="true" VisibleIndex="2" Settings-AutoFilterCondition="Contains"
                    HeaderStyle-HorizontalAlign="Center"
                    Caption="Tên công đoạn" FieldName="nv_Tencongdoan_vn" Width="60%">
                </dx:GridViewDataColumn>
