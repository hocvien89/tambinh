<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rp_Baocao_Nhanvien_Kythuat.aspx.vb" Inherits="NANO_SPA.Rp_Baocao_Nhanvien_Kythuat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    ...
    <fieldset class="field_tt">
        ...
        <ul style="padding-left: 86px">
            ...
            <li class="text_title">
                <dx:ASPxComboBox runat="server" ID="cb_Nhanvien" DropDownStyle="DropDownList" IncrementalFilteringMode="StartsWith" Height="25px" Width="200px" SelectedIndex="0"></dx:ASPxComboBox>
            </li>
            <li class="text_title">
    ...
    <div style="width: 1075px; margin: auto; text-align: center">
        <dx:ReportToolbar ID="ReportToolbar1" runat='server' ShowDefaultButtons='False' ReportViewerID="ReportViewer_BC" Width="1075">
            <Items>
        ...
        <dx:ReportViewer ID="ReportViewer_BC" runat="server"></dx:ReportViewer>
    </div>
</asp:Content>
