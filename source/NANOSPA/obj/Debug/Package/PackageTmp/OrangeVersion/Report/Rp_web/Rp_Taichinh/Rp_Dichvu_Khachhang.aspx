<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rp_Dichvu_Khachhang.aspx.vb" Inherits="NANO_SPA.Rp_Dichvu_Khachhang" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    ...
    <fieldset class="field_tt">
        ...
        <ul style="padding-left: 86px">
            ...
            <li class="text_title">
                <dx:ASPxDateEdit ID="ASPx_Tungay" runat="server" EditFormat="Custom" Date="2015-04-01" EditFormatString="dd/MM/yyyy"></dx:ASPxDateEdit>
            </li>
            <li class="text_title">Đến ngày: </li>
            <li class="text_title">
                <dx:ASPxDateEdit ID="Aspx_Thang" runat="server" EditFormat="Custom" Date="2015-04-01" EditFormatString="dd/MM/yyyy"></dx:ASPxDateEdit>
            </li>
            <li class="text_title">
    ...
    <div style="width: 1075px; margin: auto; text-align: center">
        <dx:ReportToolbar ID="ReportToolbar1" runat='server' ShowDefaultButtons='False' Width="1075" ReportViewerID="ReportViewer1">
            <Items>
