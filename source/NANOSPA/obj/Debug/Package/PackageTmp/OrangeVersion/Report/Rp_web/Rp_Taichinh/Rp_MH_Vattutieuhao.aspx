<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rp_MH_Vattutieuhao.aspx.vb" Inherits="NANO_SPA.Rp_MH_Vattutieuhao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
     <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO VẬT TƯ TIÊU HAO</p>
            </li>
        </ul>
    </div>
    <fieldset class="field_tt">
        ...
        <ul style="padding-left: 86px">
            ...
            <li class="text_title">
                <dx:ASPxComboBox ID="cboKho" runat="server" ></dx:ASPxComboBox>
            </li>
            <li class="text_title">
    ...
    <div style="width: 763px; margin: auto; text-align: center">
