<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rp_Hoahong_BanSP.aspx.vb" Inherits="NANO_SPA.Rp_Hoahong_BanSP" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO HOA HỒNG BÁN SẢN PHẨM</p>
            </li>
        </ul>
    </div>
    <fieldset class="field_tt">
        ...
        <ul style="padding-left: 86px">
            ...
            <li class="text_title">
                <dx:ASPxComboBox ID="cbo_Kho" runat="server" DropDownStyle="DropDownList"></dx:ASPxComboBox>
            </li>
