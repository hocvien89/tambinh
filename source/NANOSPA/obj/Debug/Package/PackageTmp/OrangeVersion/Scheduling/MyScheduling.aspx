    ...
    <div class="box_lichhen">
        <dxwschs:ASPxScheduler ID="scheduler1" runat="server" ActiveViewType="Timeline" Width="1000px" AppointmentDataSourceID="SqlDataSource1" 
            ...
            <Views>
                ...
                <TimelineView ResourcesPerPage="15" IntervalCount="16" WorkTime-End="22:00:00" WorkTime-Start="7:00:00">
                   <%-- <Templates>
                        <ToolbarViewVisibleIntervalTemplate>
            ...
            <Storage EnableReminders="true">
                <Appointments CommitIdToDataSource="false" AutoRetrieveId="true">
                    ...
                    <labels>
                    <%--<dxwschs:AppointmentLabel Color="Window" DisplayName="None" MenuCaption="&amp;Không" />--%>
                    <dxwschs:AppointmentLabel Color="#F23A62" DisplayName="Hẹn lịch" MenuCaption="&amp;Hẹn lịch" />
                <%--    <dxwschs:AppointmentLabel Color="168, 213, 255" DisplayName="Chuyển lịch" MenuCaption="&amp;Chuyển lịch" />--%>
