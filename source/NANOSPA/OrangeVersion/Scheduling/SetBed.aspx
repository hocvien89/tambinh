...
<%@ Register Src="~/CONTROL/MyDataviewControl.ascx" TagPrefix="uc1" TagName="MyDataviewControl" %>
                            ...
                            <table width="100%">
                                <tr style ="margin:auto">
                                    ...
                                    <td style="padding-left:10px">
                                        <dx:ASPxDataView ID="DvGiuongDetail" runat="server" OnDataBinding="DvGiuongDetail_DataBinding" RowPerPage="2" ColumnCount="9" ItemStyle-Height="100px" ItemStyle-Width="120px">
