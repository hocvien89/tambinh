...
Partial Public Class SendEmail
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents txtChude As Global.System.Web.UI.WebControls.TextBox

    '''<summary>
    '''htmleditor_noidung control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents htmleditor_noidung As Global.DevExpress.Web.ASPxHtmlEditor.ASPxHtmlEditor
