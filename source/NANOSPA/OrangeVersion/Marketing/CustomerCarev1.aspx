<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="CustomerCarev1.aspx.vb" Inherits="NANO_SPA.CustomerCare" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowWorkWindow(uId_KH_Tiemnang) {
            jo_CreateSession("uId_KH_Tiemnang", uId_KH_Tiemnang);
            jo_CreateSession("tags", "");
            window.location.href = "../../OrangeVersion/Marketing/AddWork.aspx";
            return false;
        }
        ...
        function OkClick(s, e) {
            ...
            if (txtMaKH.value == "") {
                ...
                return false;
            } else if (CheckExist("sdt", txtSDT.value) == "existsdt") {
        ...
        function ClearText() {
            ...
            var pageUrl = "../../../../Webservice/nano_websv.asmx/CreateNewCustomerMarketCode";
            $.ajax({
                type: "POST",
                url: pageUrl,
                contentType: "application/json; charset=utf-8",
        ...
        function SelChanged(s, e) {
            if (!e.isSelected) {
                ...
                client_grid.GetRowValues(e.visibleIndex, 'v_Makhachhang;uId_KH_Tiemnang;uId_Chuyendoi', OnGridSelectionComplete);
            }
        }
    ...
    <fieldset class="field_tt">
        ...
        <div>
            <ul>
<%--            <li class="text_title">
                <dx:ASPxCheckBox ID="chkViewAll" OnCheckedChanged="chkViewAll_CheckedChange" AutoPostBack="true" Text="Xem tất cả" runat="server">
                </dx:ASPxCheckBox>
            </li>--%>
            ...
            <li class="text_title">
                <dx:ASPxComboBox ID="cboLoaikhachhang" runat="server" Width="100px">
                    <Items>
                        <dx:ListEditItem Text="Tiềm năng" Value="tiemnang" />
                        <dx:ListEditItem Text="Hệ thống" Value="hethong" />
                    </Items>
                </dx:ASPxComboBox>
            </li>
            <li class="text_title">
                <dx:ASPxButton ID="btnFilter" Width="100px" Image-Url="~/images/16x16/filter.png" Height="20px" Style="bottom: 5px; position: relative"
                    ...
                    <ClientSideEvents Click="locClientClick" />
                </dx:ASPxButton>
            </li>
        </ul>
        </div>
...
<ul>
            ...
            <li class="text_title">
                <dx:ASPxButton ID="btn_ImportExcel" Image-Url="~/images/Excel-icon.png" Height="20px" Style="bottom: 5px; position: relative" AutoPostBack="false"
    ...
    <fieldset class="field" style="width: 98%; height: auto; margin: auto">
        <legend ><span style="font-weight:bold; color:green">Danh sách khách hàng :
    ...
    <dx:ASPxGridView ID="dgvDevexpress" runat="server" ClientInstanceName="client_grid" OnRowDeleting="dgvDevexpress_RowDeleting"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Visible="true" VisibleIndex="1" Settings-AutoFilterCondition="Contains"
                Width="100px" HeaderStyle-HorizontalAlign="Center" Caption="Mã KH" FieldName="v_Makhachhang"
                Name="v_Makhachhang">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Visible="true" VisibleIndex="1" Settings-AutoFilterCondition="Contains"
            ...
            <dx:GridViewDataColumn Width="40px" VisibleIndex="4" CellStyle-HorizontalAlign="Center">
                <DataItemTemplate>
                    <a id="popup" title="Thêm công việc" href='javascript:void(0)' onclick="return <%# String.Format("ShowWorkWindow('{0}')", Eval("uId_KH_Tiemnang")).ToString%>">
                                    ...
                                    <fieldset class="field_tt">
                                        ...
                                        <table class="info_table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="info_table_td">
                                                    <dx:ASPxDateEdit ID="deNgaysinh" UseMaskBehavior="true" onkeypress="return enter_deNgaysinh(event)" ClientInstanceName="deNgaysinh" Style="float: left; margin-right: 8px;" Width="104px" Height="25px" EditFormat="DateTime" EditFormatString="dd/MM/yyyy"
                                                        runat="server">
                                                    </dx:ASPxDateEdit>
                                            ...
                                            <tr>
                                                ...
                                                <td class="info_table_td" colspan="3">
                                                    <asp:TextBox ID="txtGhichu" TextMode="MultiLine" onkeypress="return enter_txtGhichu(event)" runat="server" Width="514px" CssClass="nano_textbox"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="5">
                                            ...
                                            <tr>
                                                <td colspan="5">
                                                    <div class="pcmButton">
                                                        ...
                                                        <dx:ASPxButton ID="btaddbill" OnClick="btaddbill_Click" Image-Url="~/images/16x16/report_go.png" runat="server" Text="Thêm công việc" AutoPostBack="False" Style="float: left; margin-right: 8px">
                                                        </dx:ASPxButton>
                                                    </div>
                                                </td>
                                            </tr>
