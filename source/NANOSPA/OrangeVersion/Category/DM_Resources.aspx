<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="DM_Resources.aspx.vb" Inherits="NANO_SPA.DM_Resources" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    ...
    <div class="brest_crum">
        <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>DANH MỤC PHÒNG DỊCH VỤ</p>
    </div>
    <fieldset class="field_tt_left" style="width: 98%; height: auto; margin: auto">
        <dx:ASPxGridView ID="Grid_DMThuchi" runat="server" OnRowDeleting="Grid_DMThuchi_RowDeleting" OnRowInserting="Grid_DMThuchi_RowInserting" OnRowUpdating="Grid_DMThuchi_RowUpdating"  KeyFieldName="ResourceID" Width="100%" 
           >
            <Columns>
                <dx:GridViewDataTextColumn Visible="false" VisibleIndex="-1" Settings-AutoFilterCondition="Contains"
                    HeaderStyle-HorizontalAlign="Center"
                    Caption="" FieldName="ResourceID" Name="ResourceID">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataColumn Caption="Tên phòng" VisibleIndex="1" FieldName="ResourceName" 
                    Name="ResourceName" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains">
                </dx:GridViewDataColumn>
               

                <dx:GridViewCommandColumn Width="50px" VisibleIndex="3" Caption="Thêm" ButtonType="Image" HeaderStyle-HorizontalAlign="Center">
                    <CancelButton>
                ...
                <dx:GridViewCommandColumn VisibleIndex="4" Width="50px" Caption="Xóa" HeaderStyle-HorizontalAlign="Center" ButtonType="Image">
