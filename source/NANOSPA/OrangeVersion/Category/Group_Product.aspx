<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Group_Product.aspx.vb" Inherits="NANO_SPA.Group_Product" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
        <script type="text/javascript">
            $(document).ready(function () {
                var param_dt = "{'uId_Chucnang':'314ee967-ef8b-4c0b-9544-7b23c5bb2a1d'}";
    ...
    <div class="brest_crum">
        <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>QUẢN LÍ DANH MỤC NHÓM THUỐC</p>
    </div>
    <fieldset class="field_tt_left" style="width: 98%; height: auto; margin: auto">
        <dx:ASPxGridView ID="Grid_GroupProduct" runat="server" KeyFieldName="uId_Nhommathang" Width="100%" AutoGenerateColumns="false">
            <Columns>
                <dx:GridViewDataTextColumn Visible="false" VisibleIndex="-1" Settings-AutoFilterCondition="Contains"
                    HeaderStyle-HorizontalAlign="Center"
                    Width="100px" Caption="" FieldName="uId_Nhommathang" Name="uId_Nhommathang">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataColumn Caption="Mã nhóm thuốc" VisibleIndex="1" FieldName="nv_Tennhommathang_en"
                    Name="nv_Tencuahang_en" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains">
                </dx:GridViewDataColumn>
                <dx:GridViewDataColumn Visible="true" VisibleIndex="2" Settings-AutoFilterCondition="Contains"
                    HeaderStyle-HorizontalAlign="Center" 
                    Caption="Tên nhóm thuốc" FieldName="nv_Tennhommathang_vn" Width="60%">
                </dx:GridViewDataColumn>
