<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Source.aspx.vb" Inherits="NANO_SPA.Source" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
  ...
  <script type="text/javascript">
    ...
    <div class="brest_crum">
        <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>DANH MỤC NGUỒN</p>
    </div>
    <fieldset class="field_tt_left" style="width: 98%; height: auto; margin: auto">
        <dx:ASPxGridView ID="Grid_Other" runat="server" OnRowInserting="Grid_Other_RowInserting" OnRowDeleting="Grid_Other_RowDeleting" OnRowUpdating="Grid_Other_RowUpdating" KeyFieldName="uId_Nguon" Width="100%" 
            >
            <Columns>
                <dx:GridViewDataColumn VisibleIndex="1" FieldName="uId_Nguon" Visible="false"
                 ...
                 <dx:GridViewDataColumn VisibleIndex="1" FieldName="nv_Nguon_vn" Visible="true"
                    Name="nv_Nguon_vn" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" Width="15%">
                </dx:GridViewDataColumn>
                <dx:GridViewDataColumn Visible="true" VisibleIndex="2" Settings-AutoFilterCondition="Contains"
                    HeaderStyle-HorizontalAlign="Center" 
                    Caption="Loại" FieldName="vType" Width="35%">
                </dx:GridViewDataColumn>
