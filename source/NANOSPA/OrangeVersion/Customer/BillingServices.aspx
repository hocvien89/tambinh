...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ClosePopupDonThuoc() {
            pcDanhsachDonthuoc.Hide();
            return false;
        }
        function ClosePopup() {
        ...
        function InitPopupMenuHandler(s, e) {
          ...
          function SelChanged_Donthuoc(s, e) {
              if (!e.isSelected) {
              } else {
                  client_dgvDanhsachdonthuoc.GetRowValues(e.visibleIndex, 'uId_Phieuxuat;v_Maphieuxuat;uId_Khachhang', OnGridSelectionDSPhieuCompletePX);
              }
          }
          function OnGridSelectionDSPhieuCompletePX(values) {
              ...
              $.ajax({
                  ...
                  dataType: "json",
                  async: false,
                  success: OnSuccessCall_Donthuoc,
                  error: onFail
              });
          }
          function OnSuccessCall_Donthuoc(msg) {
              if (msg.d != "") {
                  var lblTienthuatext = document.getElementById("<%=lblTienthuatext_PX.ClientID%>");
                var defaultdata = msg.d.split("$");
                var txtMaphieu = document.getElementById("<%=txtMaphieu.ClientID%>");
        ...
        <fieldset class="field_thanhtoan">
            ...
            <div class="box_thanhtoan" style="min-height: 350px;">
                ...
                <ul style="float: left">
                    ...
                    <li class="text_title" style="padding-left: 21px">
                        ...
                        <dx:PanelContent ID="PanelContent9" runat="server">
                            <asp:UpdatePanel ID="upKhachhang" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div style="clear: both"></div>
                                    <dx:ASPxGridView ID="ASPxGridView1" OnRowDeleting="ASPxGridView1_RowDeleting" runat="server" ClientInstanceName="client_dgvDanhsachdonthuoc"
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataColumn Width="30px" VisibleIndex="4" CellStyle-HorizontalAlign="Center">
                                                <DataItemTemplate>
                                                    <a id="popup" title="Chọn đơn thuốc" href='javascript:void(0)' onclick="return ClosePopupDonThuoc()">
                                                        <img src="../../../images/bub.png" /></a>
                                                </DataItemTemplate>
                                        ...
                                        <SettingsBehavior AllowFocusedRow="true" AllowMultiSelection="true" ConfirmDelete="true" ColumnResizeMode="NextColumn" EnableCustomizationWindow="true" />
                                        <SettingsText ConfirmDelete="Bạn có muốn xóa không?" />
                                        <ClientSideEvents EndCallback="grid_EndCallback" SelectionChanged="function(s, e) { SelChanged_Donthuoc(s, e); }" />
                                        <Styles>
                                            <AlternatingRow Enabled="True" BackColor="#EAFCFF">
                                            </AlternatingRow>
                                        </Styles>
