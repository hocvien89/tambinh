<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="CustomerPotential.aspx.vb" Inherits="NANO_SPA.CustomerPotential" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    ...
    <div class="brest_crum">
            ...
            <li>
                        <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>THỐNG KÊ KHÁCH HÀNG TIỀM NĂNG </p>
            </li>
        </ul>
    ...
    <fieldset class="field_tt">
        ...
        <div style="height: 30px; width:82%;margin:auto   ">
            <ul>
                ...
                <li class="text_title" style="margin-left: 5px">
                    <dx:ASPxCheckBox ID="chk_Cuahang" runat="server" Text="Cửa hàng:" />
                </li>
                <li class="text_title" style="margin-left: 5px">
...
<%--                    <dx:ASPxButton ID="btn_ImportExcel" Image-Url="~/images/Excel-icon.png" Height="20px" Style="bottom: 5px; position: relative" AutoPostBack="false"
    ...
    <fieldset class="field" style="width: 98%; height: auto; margin: auto">
        <legend><span style="font-weight: bold; color: green;">Thông tin khách hàng</span></legend>
                     <dx:ASPxGridView ID="Grid_KH_Tiemnang" KeyFieldName="v_Makhachhang" ClientInstanceName="client_grid" AutoGenerateColumns="false" runat="server"
            SettingsPager-PageSize="17" >
            <Columns>
                <dx:GridViewDataColumn Caption="Mã Khách hàng" HeaderStyle-HorizontalAlign="Center" FieldName="v_Makhachhang" VisibleIndex="0"
                ...
                <dx:GridViewDataColumn Caption="Ngày sinh" Visible="true" VisibleIndex="2" FieldName="d_Ngaysinh"
                    Settings-AutoFilterCondition="Contains" Width="10%" Name="d_Ngaysinh" HeaderStyle-HorizontalAlign="Center">
                </dx:GridViewDataColumn>
                ...
                <dx:GridViewDataColumn Caption="Số điện thoại" Visible="true" VisibleIndex="5" FieldName="v_DienthoaiDD"
                    Settings-AutoFilterCondition="Contains" Width="10%" Name="v_DienthoaiDD" HeaderStyle-HorizontalAlign="Center">
                </dx:GridViewDataColumn>

                <dx:GridViewDataTextColumn Caption="Ngày Nhập" Visible="true" VisibleIndex="6" FieldName="d_Ngaynhap" SortIndex="0" PropertiesTextEdit-DisplayFormatString="dd/MM/yyyy"
                    Settings-AutoFilterCondition="Contains" Width="85px" Name="d_Ngaynhap" HeaderStyle-HorizontalAlign="Center" >
