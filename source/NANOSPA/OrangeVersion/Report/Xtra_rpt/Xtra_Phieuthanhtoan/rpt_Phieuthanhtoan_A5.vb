Public Class rpt_Phieuthanhtoan_A5
    Public Sub BindData(ByVal uId_Phieudichvu As String, ByVal uId_Khachhang As String, ByVal nv_Tencuahang_vn As String, ByVal nv_Diachicuahang As String)
        ...
        lblConlai.Text = String.Format("{0:#,##}", Val(objEnPhieuDV.nv_Ghichu_en) - Val(objEnPhieuDV.f_Giamgia))
        ...
        tienthua = Val(objEnPhieuDV.nv_Ghichu_en) - Val(objEnPhieuDV.f_Giamgia) - tiennhan
        If tienthua < 0 Then
            lbTienthutext.Text = "Tiền thừa"
            tienthua = tienthua * (-1)
        End If
        lblTienthua.Text = String.Format("{0:#,##}", tienthua)
        lblGhichu.Text = objEnPhieuDV.nv_Ghichu_vn
        ...
        lblHinhthuc.Text = objFCLoaihinhTT.SelectByID(objEnPhieuDV.uId_LoaiTT).nv_TenLoaiTT
    End Sub
End Class