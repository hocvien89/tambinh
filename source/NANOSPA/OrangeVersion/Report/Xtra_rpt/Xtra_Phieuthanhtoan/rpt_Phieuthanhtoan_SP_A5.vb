Public Class rpt_Phieuthanhtoan_SP_A5
    Public Sub BindData(ByVal uId_Phieuxuat As String, ByVal uId_Khachhang As String, ByVal nv_Tencuahang_vn As String, ByVal nv_Diachicuahang As String)
        ...
        lblGhichu.Text = objEnPhieuxuat.nv_Noidungxuat_vn
        ...
        lblHinhthuc.Text = objFCLoaihinhTT.SelectByID(objEnPhieuxuat.uId_LoaiTT).nv_TenLoaiTT
    End Sub
End Class