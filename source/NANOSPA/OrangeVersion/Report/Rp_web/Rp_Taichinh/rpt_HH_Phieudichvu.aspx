<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="rpt_HH_Phieudichvu.aspx.vb" Inherits="NANO_SPA.rpt_HH_Phieudichvu" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO HOA HỒNG PHIẾU DỊCH VỤ</p>
            </li>
        </ul>
    </div>
    <fieldset class="field_tt">
        ...
        <ul style="padding-left: 86px">
            ...
            <li class="text_title">
                <dx:ASPxComboBox ID="cbo_nhanvien" Width="200px" AutoPostBack="false" runat="server" ValueType="System.String"></dx:ASPxComboBox>
            </li>
            <li class="text_title">
