<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rp_TonghopXuat.aspx.vb" Inherits="NANO_SPA.Rp_TonghopXuat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>TỔNG HỢP XUẤT</p>
            </li>
        </ul>
    </div>
    <fieldset class="field_tt">
        ...
        <ul style="padding-left: 86px">
            ...
            <li class="text_title">Kho</li>
            <li class="text_title">
                <dx:ASPxComboBox ID="cbo_Kho" runat="server" width="200px" AutoPostBack="false"></dx:ASPxComboBox>
            </li>
    ...
    <div style="width: 740px; margin: auto; text-align: center">
        <dx:ReportToolbar ID="ReportToolbar1" runat='server' ShowDefaultButtons='False' ReportViewerID="ReportViewer1" Width="768px">
            <Items>
