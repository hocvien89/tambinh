<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rp_Chitiet_Doanhthu_DV.aspx.vb" Inherits="NANO_SPA.Rp_Chitiet_Doanhthu_DV" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO DOANH THU CHI TIẾT DỊCH VỤ</p>
            </li>
        </ul>
    </div>
