<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rp_Tonghop_Dichvu.aspx.vb" Inherits="NANO_SPA.Rp_Tonghop_Dichvu" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO DOANH THU TÔNG HỢP DỊCH VỤ</p>
            </li>
        </ul>
    </div>
