<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rpt_DoanhthuNVTuvan.aspx.vb" Inherits="NANO_SPA.Rpt_DoanhthuNVTuvan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO DOANH THU NHÂN VIÊN TƯ VẤN</p>
            </li>
        </ul>
    </div>
    <fieldset class="field_tt">
        ...
        <ul style="padding-left: 86px">
            ...
            <li class="text_title">
                <dx:ASPxComboBox ID="cbonhanvien" IncrementalFilteringMode="Contains" AutoPostBack="false"  DropDownStyle="DropDown" runat="server" ValueType="System.String">
                  
                </dx:ASPxComboBox>
            </li>
            <li class="text_title">
                <dx:ASPxButton ID="btn_Baocao" OnClick="btn_Baocao_Click" Image-Url="~/images/16x16/report_go.png" Height="20px" Style="bottom: 5px; position: relative" AutoPostBack="false"
