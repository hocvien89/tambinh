<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rp_Tonghop_MH.aspx.vb" Inherits="NANO_SPA.Rp_Tonghop_MH" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
     <div class="brest_crum">
          <ul>
            ...
            <li>
        <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO TỔNG HỢP DOANH THU MẶT HÀNG</p>
                </li>
              </ul>
    </div>
    <fieldset class="field_tt">
        ...
        <ul style="padding-left:86px">
            ...
            <li class="text_title">
                <dx:ASPxButton ID="Aspx_Baocao" Image-Url="~/images/16x16/report_go.png" Height="20px" Style="bottom: 5px; position: relative" AutoPostBack="false"
