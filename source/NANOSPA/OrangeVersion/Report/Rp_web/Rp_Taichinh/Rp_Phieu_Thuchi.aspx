<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rp_Phieu_Thuchi.aspx.vb" Inherits="NANO_SPA.Rp_Phieu_Thuchi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO PHIẾU THU CHI</p>
            </li>
        </ul>
    </div>
    <fieldset class="field_tt">
        ...
        <ul style="padding-left: 86px">
            <li class="text_title">Loại phiếu </li>
            <li class="text_title">
                <dx:ASPxComboBox ID="cbo_Loaiphieu" runat="server" DropDownStyle="DropDownList" Width="100px">
                    <Items>
                        <dx:ListEditItem Value="TONGHOP" Text="Tổng hợp" />
                        <dx:ListEditItem Value="THU" Text="Phiếu thu" />
                        <dx:ListEditItem Value="CHI" Text="Phiếu chi" />
                    </Items>
                </dx:ASPxComboBox>
            </li>
            <li class="text_title">Cửa hàng </li>
            <li class="text_title">
                <dx:ASPxComboBox ID="cbo_Cuahang" runat="server" DropDownStyle="DropDownList">
                    <Items>
                        <dx:ListEditItem Value="0" Text="Tất cả cửa hàng" />
                    </Items>
                </dx:ASPxComboBox>
            </li>
