<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="Rp_Taichinh_Tonghop.aspx.vb" Inherits="NANO_SPA.Rp_Taichinh_Tonghop" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO TÀI CHÍNH TỔNG HỢP</p>
            </li>
        </ul>
    </div>
    <fieldset class="field_tt">
        ...
        <ul style="padding-left: 86px">
            ...
            <li class="text_title">
                <dx:ASPxComboBox ID="cbo_Cuahang" runat="server"></dx:ASPxComboBox>
            </li>
            <li class="text_title">
