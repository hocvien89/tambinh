<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="rpt_Mother.aspx.vb" Inherits="NANO_SPA.rpt_Mother" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <script type="text/javascript">
        var last_value = null;
        function Onchanger(cbo_khachhang) {
            if (cbo_Phieuchitiet.InCallback())
                last_value = cbo_khachhang.GetValue().toString();
            else
                cbo_Phieuchitiet.PerformCallback(cbo_khachhang.GetValue().toString());
        }
        function callbackCB(s, e) {
            if (last_value) {
                cbo_Phieuchitiet.PerformCallback(last_value);
                last_value = null;
            }
        }
    </script>
    ...
    <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO CHĂM SÓC BẦU</p>
            </li>
        </ul>
    </div>
    <fieldset class="field_tt">
        ...
        <ul style="padding-left: 86px">
            ...
            <li class="text_title">
                <dx:ASPxComboBox ID="cbo_khachhang" DropDownStyle="DropDown" ClientInstanceName="cbo_khachhang" IncrementalFilteringMode="StartsWith" runat="server">
                     <ClientSideEvents SelectedIndexChanged="function(s, e) { Onchanger(s);}" />
                </dx:ASPxComboBox>
            </li>
            <li class="text_title">Dịch vụ: </li>
            <li class="text_title">
                <dx:ASPxComboBox ID="cbo_Phieuchitiet" DropDownStyle="DropDown" EnableCallbackMode="true" ClientInstanceName="cbo_Phieuchitiet" IncrementalFilteringMode="StartsWith" OnCallback="cbo_Phieuchitiet_Callback1" runat="server">
                    <ClientSideEvents EndCallback="callbackCB" />
                </dx:ASPxComboBox>
            </li>
            <li class="text_title">
                <dx:ASPxButton ID="btn_Baocao" Image-Url="~/images/16x16/report_go.png" OnClick="btn_Baocao_Click" Height="20px" Style="bottom: 5px; position: relative" AutoPostBack="false"
                    runat="server" Text="Lọc">
                </dx:ASPxButton>
            </li>
        </ul>
    </fieldset>
    <div style="width: 58%; margin: auto; text-align: center">
