<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frmMain.Master" CodeBehind="rp_Baocaothongketheonguon.aspx.vb" Inherits="NANO_SPA.rp_Baocaothongketheonguon" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <div class="brest_crum">
        <ul>
            ...
            <li>
                <p class="p_header"><i class="fa fa-user fa-fw fa-1x"></i>BÁO CÁO NGUỒN KHÁCH HÀNG</p>
            </li>
        </ul>
    </div>
