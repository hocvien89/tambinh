Public Class PQP_NHANVIEN_PHONGFacade
    ...
    Public Function SelectNhanVienThuocPhong(ByVal uId_Cuahang As String) As System.Data.DataTable
        Return IPQP_NHANVIEN_PHONG.SelectNhanVienThuocPhong(uId_Cuahang)
    End Function
