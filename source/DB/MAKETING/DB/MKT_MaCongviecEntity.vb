Public Class MKT_MaCongviecEntity 
    Implements CM.IMKT_MaCongviecEntity

	Private _uId_MaCongviec AS String
	Private _nv_TenMaCongviec AS String
	Private _nv_Ghichu AS String
	
    Public Property uId_MaCongviec() As String Implements CM.IMKT_MaCongviecEntity.uId_MaCongviec
        Get
    ...
    Public Property nv_TenMaCongviec() As String Implements CM.IMKT_MaCongviecEntity.nv_TenMaCongviec
        Get
    ...
    Public Property nv_Ghichu() As String Implements CM.IMKT_MaCongviecEntity.nv_Ghichu
        Get
            Return _nv_Ghichu
        End Get
        Set(ByVal value As String)
