...
Public Class PQP_NHANVIEN_PHONGDA
    ...
    Public Function SelectNhanVienThuocPhong(ByVal uId_Cuahang As String) As System.Data.DataTable Implements IPQP_NHANVIEN_PHONGDA.SelectNhanVienThuocPhong
        Dim db As Database
        Dim sp As String = "[dbo].[spPQP_NHANVIEN_PHONG_SelectNhanVienThuocPhong]"
        Dim objCmd As DbCommand
        Dim objDs As DataSet
        Try
            db = DatabaseFactory.CreateDatabase()
